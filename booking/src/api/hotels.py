...
async def create_hotel(
    ...
    hotel = await db.hotels.add(data=hotel)
    await db.commit()
...
async def update_hotel_patch(hotel_id: int, data: HotelPatchSchema, db: DBDep, ):
...
async def update_hotel_put(hotel_id: int, data: HotelAddSchema, db: DBDep, ):
